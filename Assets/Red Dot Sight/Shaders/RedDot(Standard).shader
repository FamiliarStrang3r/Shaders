...
Shader "Vashchuk/RedDot(Standard)"
{
	Properties
	{
		...
		_RedDotDist ("Distance", Range(0,50)) = 2.0
		_Offset("V2 Offset", Vector) = (0, 0, 0, 0)
	...
	SubShader
	{
		...
		void vert(inout appdata_full v, out Input o)
		{
			...
			o.RedDotUV = v.vertex.xy - _Offset;// - fixed2(_OffsetX, _OffsetY); //+ fixed2(0.5, 0.5);//plus half-vector not me
