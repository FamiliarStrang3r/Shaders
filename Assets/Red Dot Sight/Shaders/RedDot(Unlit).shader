Shader "Vashchuk/RedDot(Unlit)"
{
	Properties
	{
		...
		_RedDotDist ("Red Dot offset distance", Range(20, 50)) = 20.0
	...
	SubShader
	{
		...
		Pass 
		{
            ...
            fixed4 frag (v2f i): COLOR
			{
				...
				fixed redDotAlpha = tex2D(_RedDotTex, i.RedDotUV).a;
				col.rgb += redDotAlpha * _RedDotColor.rgb * _RedDotColor.a;
				col.a += redDotAlpha * _RedDotColor.a;
                return col;
            }
            ENDCG
		}
